...
class Registration extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('candidate_number, marital_status, number_child, child_id, mobile_no', 'numerical', 'integerOnly'=>true),
			...
			array('id, candidate_number, first_name, last_name, marital_status, number_child, dob, aniversary_date, child_id, mobile_no, pan_number, address, other_address, profile_picture', 'safe', 'on'=>'search'),
		);
	}
	...
	public function getAll(){
		...
		$list = Yii::app()->db->createCommand('select candidate_number, first_name, last_name, marital_status,number_child,dob,
			aniversary_date,child_id,mobile_no, address,other_address,profile_picture,status from registration')->queryAll();
